import sp1pImg from "@/public/images/diagnostics/specularMicroscope/sp-1p.png";
import ProductDetails from "@/components/productDetails/ProductDetails";

import type { Metadata } from "next";
export const metadata: Metadata = {
  title: "SP-1P – Advanced Lifescience Technologies",
  description: "Easy-to-use automated endothelial analysis",
  alternates: {
    canonical:
      "https://www.altplnepal.com/products/diagnostics/specular-microscope/sp-1p/",
  },
};
